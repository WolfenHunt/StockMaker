      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <button type="submit" class="btn btn-danger"><a href="media.php">Subir imagen</a></button>
         </strong>
        </div>
        <div class="panel-body">
         <div class="col-md-12">
          <form method="post" action="add_product.php" class="clearfix">
              ...
              <br> <br>
              <button type="submit" class="btn btn-danger"><a href="product.php">Inventario</button>
          </form>
         </div>
        </div>
      </div>
